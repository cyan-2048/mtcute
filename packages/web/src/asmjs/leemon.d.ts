...
declare module 'leemon' {
    ...
    export function addShift_(x: Array<number>, y: Array<number>, ys: number): void
    ...
    export function divide_(x: Array<number>, y: Array<number>, q: Array<number>, r: Array<number>): void

    export function dup(x: Array<number>): Array<number>

    export function eGCD_(x: Array<number>, y: Array<number>, v: Array<number>, a: Array<number>, b: Array<number>): void
    ...
    export function greaterShift(x: Array<number>, y: Array<number>, shift: number): 1 | 0

    export function halve_(x: Array<number>): void

    export function int2bigInt(t: number, bits: number, minSize: number): Array<number>

    export function inverseMod(x: Array<number>, n: Array<number>): Array<number> | null
    ...
    export function linCombShift_(x: Array<number>, y: Array<number>, b: number, ys: number): void

    export function linComb_(x: Array<number>, y: Array<number>, a: number, b: number): void
    ...
    export function mont_(x: Array<number>, y: Array<number>, n: Array<number>, np: number): void

    export function mult(x: Array<number>, y: Array<number>): Array<number>

    export function multInt_(x: Array<number>, n: number): void

    export function multMod(x: Array<number>, y: Array<number>, n: Array<number>): Array<number>

    export function multMod_(x: Array<number>, y: Array<number>, n: Array<number>): void
    ...
    export function powMod(x: Array<number>, y: Array<number>, n: Array<number>): Array<number>

    export function powMod_(x: Array<number>, y: Array<number>, n: Array<number>): void
    ...
    export function str2bigInt(s: string, base: number, minSize?: number): Array<number>

    export function sub(x: Array<number>, y: Array<number>): Array<number>

    export function subShift_(x: Array<number>, y: Array<number>, ys: number): void
